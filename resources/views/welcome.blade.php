        ...
        <div class="container-wrap">
            ...
            <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
                <div class="text-center">
                    {{-- Background-image di-load dari storage --}}
                    <div class="author-img"
                        style="background-image: url('{{ $resume->image_resume
                            ? asset("storage/{$resume->image_resume}")
                            : asset('templates/jackson/images/about.jpg') }}');">
                    </div>
                    ...
                    {{-- Posisi & Negara --}}
                    <span class="position">
                        <a href="#">{{ $resume->posisi }}</a> in {{ $resume->negara }}
                    </span>
                </div>
                ...
                <div class="colorlib-footer">
                    <p><small>&copy;
                            ...
                            <script>
                                ...
                                aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Iwan
                                Hermawan</a>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </span>
                        </small></p>
                ...
                <section id="colorlib-hero" class="js-fullheight" data-section="home">
                    <div class="flexslider js-fullheight">
                        <ul class="slides">
                            ...
                            <li style="background-image: url({{ asset("storage/{$heroes->background_image}") }});">
                                <div class="overlay"></div>
                                <div class="container-fluid">
                                    <div class="row">
                                        <div
                                            class="col-md-6 col-md-offset-3 col-md-pull-3
                          col-sm-12 col-xs-12 js-fullheight slider-text">
                                            <div class="slider-text-inner js-fullheight">
                                                <div class="desc">
                                                    <h1>{!! nl2br(e($heroes->heading)) !!}</h1>
                                                    @if ($heroes->subheading)
                                                        <h2>{!! nl2br(e($heroes->subheading)) !!}</h2>
                                                    @endif
                                                    @if ($heroes->button_text && $heroes->button_url)
                                                        <p>
                                                            <a href="{{ $heroes->button_url }}"
                                                                class="btn btn-primary btn-learn">
                                                                {{ $heroes->button_text }} <i
                                                                    class="icon-download4"></i>
                                                            </a>
                                                        </p>
                                                    @endif
                                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                    <div class="col-md-12">
                                        <div class="about-desc">
                                            {{-- jika ingin judul kecil tetap “About Us”, bisa hard-code atau simpan di DB --}}
                                            <span class="heading-meta">About Us</span>

                                            {{-- judul besar, misal subtitle --}}
                                            <h2 class="colorlib-heading">{{ $about->title ?? 'Who Am I?' }}</h2>

                                            {{-- deskripsi — asumsikan di DB pakai HTML atau newline --}}
                                            @if (!empty($about->description))
                                                {{-- jika di DB plain text dengan newline --}}
                                                {!! nl2br(e($about->description)) !!}
                                                {{-- atau, jika di DB sudah simpan HTML safe, cukup: {!! $about->description !!} --}}
                                            @else
                                ...
                                <div class="row">
                                    <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                                        <div class="hire">
                                            <h2>Saya senang mengetahui bahwa <br> 50+ proyek telah berhasil
                                                diselesaikan!
                                            </h2>
                                            <a href="https://wa.me/6285771737414?text=Halo%20saya%20tertarik%20dengan%20CV%20Anda"
                                                class="btn-hire" target="_blank" rel="noopener noreferrer">
                                                Hubungi Saya
                                            </a>
                                        </div>
                                    </div>
                ...
                <div id="colorlib-counter" class="colorlib-counters"
                    ...
                    <div class="colorlib-narrow-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center animate-box">
                                <span class="colorlib-counter js-counter" data-from="0" data-to="356"
                                    data-speed="5000" data-refresh-interval="50"></span>
                            ...
                            @foreach ($skills as $skill)
                                <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                    <div class="progress-wrap">
                                        <h3>{{ $skill->name }}</h3>
                                        <div class="progress">
                                            <div class="progress-bar color-{{ $loop->iteration }}" role="progressbar"
                                ...
                                <div class="fancy-collapse-panel">
                                    <div class="panel-group" id="accordion" role="tablist"
                                                ...
                                                <div class="panel-heading" role="tab"
                                                    ...
                                                    <h4 class="panel-title">
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                            ...
                                                            <small
                                                                class="text-sm">({{ $edu->start_year }}{{ $edu->end_year ? ' – ' . $edu->end_year : '' }})</small>
                                                        </a>
                                                    </h4>
                                                </div>
                                                <div id="collapse{{ $i }}"
                                        ...
                                        @if ($educations->isEmpty())
                                            <p class="text-center text-gray-500">No education entries to display.</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="timeline-centered">
                                    @foreach ($experiences as $i => $exp)
                                        <article class="timeline-entry animate-box"
                                            data-animate-effect="{{ $i % 2 === 0 ? 'fadeInLeft' : 'fadeInRight' }}">
                                            <div class="timeline-entry-inner">
                                                <div class="timeline-icon color-{{ ($i % 5) + 1 }}">
                                                    <i class="icon-pen2"></i>
                                                </div>
                                                <div class="timeline-label">
                                                    <h2>
                                                        <a href="#">{{ $exp->title }}</a>
                                                        <span>{{ $exp->start_year }}{{ $exp->end_year ? '–' . $exp->end_year : '' }}</span>
                                                    </h2>
                                                    <p>{{ $exp->company }}</p>
                                    ...
                                    {{-- entry kosong untuk penanda akhir --}}
                        ...
                        <div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                            <div class="col-md-12">
                                <p class="work-menu"><span><a href="#" class="active">Graphic Design</a></span>
                                    <span><a href="#">Web Design</a></span> <span><a
                                            href="#">Software</a></span> <span><a href="#">Apps</a></span>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="colorlib-feature colorlib-feature-sm animate-box"
                                    data-animate-effect="fadeInLeft">
                                    <div class="colorlib-icon"><i class="icon-globe-outline"></i></div>
                                    <div class="colorlib-text">
                                        <p><a href="#">ihermawan227@gmail.com</a></p>
                                    </div>
                                </div>
                                <div class="colorlib-feature colorlib-feature-sm animate-box"
                                    data-animate-effect="fadeInLeft">
                                    ...
                                    <div class="colorlib-text">
                                        <p>Jl Raya Serang Km 12,5 Ds Sukadamai Kec.Cikupa
                                            Kab.Tangerang</p>
                                    </div>
                                </div>
                                <div class="colorlib-feature colorlib-feature-sm animate-box"
                                    ...
                                    <div class="colorlib-text">
                                        <p><a href="tel:+1234567890">+628 5771737414</a></p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box"
                                        ...
                                        <form action="{{ route('contacts.store') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <textarea name="message" class="form-control @error('message') border-red-600 @enderror" placeholder="Message"
